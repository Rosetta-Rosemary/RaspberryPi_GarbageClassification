...
void ClientProgram::GuiClientStatusInit()
{
    ...
    connect(PB_Fresh,SIGNAL(clicked()),this,SLOT(slot_Get_ClientStatus()));
...
void ClientProgram::Move_ClientStatus_GUI(ClientStatus &Label, bool bAdd)
{
    if (bAdd)
    {
        QPropertyAnimation *pPosAnimation = new QPropertyAnimation(Label.W_ClientStatus_PB, "pos");
        pPosAnimation->setDuration(200);
        pPosAnimation->setStartValue(QPoint(Label.W_ClientStatus_PB->x(), Label.W_ClientStatus_PB->y()));
        pPosAnimation->setEndValue(QPoint(Label.W_ClientStatus_PB->x(), Label.W_ClientStatus_PB->y()+50));
        pPosAnimation->setEasingCurve(QEasingCurve::InOutQuad);
        QParallelAnimationGroup *m_group = new QParallelAnimationGroup(this);
        m_group->addAnimation(pPosAnimation);
        m_group->setDirection(QAbstractAnimation::Forward);
...
void ClientProgram::Delete_ClientStatus_GUI(ClientStatus &Label)
{
        QPropertyAnimation *pScaleAnimation = new QPropertyAnimation(Label.W_ClientStatus_PB, "geometry");
        pScaleAnimation->setDuration(500);
        pScaleAnimation->setStartValue(QRect(Label.W_ClientStatus_PB->x(),Label.W_ClientStatus_PB->y(),
                                            Label.W_ClientStatus_PB->width(),Label.W_ClientStatus_PB->height()));
        pScaleAnimation->setEndValue(QRect(Label.W_ClientStatus_PB->x(),Label.W_ClientStatus_PB->y(),
                                            0,Label.W_ClientStatus_PB->height()));
